...
export function Fwci() {
  return (
    <Section id="fwci" title="What FWCI is">
      <P>
        FWCI is the <Strong>Field-Weighted Citation Impact</Strong>. It is
        the single best cross-field impact-per-paper metric in the explorer.
      </P>
      <P>
      ...
      <Callout>
        ...
        recent two years of citations. It is a recent-impact measure rather
        than a lifetime one. A useful framing: it answers "are this person's
        current papers landing?" rather than "what is this person's
        career-long impact?"
      </Callout>
    </Section>
  )
