...
export function SmallDepts() {
  return (
    <Section id="small-depts" title="Small departments">
      <P>
        Where possible, faculty are pulled out of generic directory buckets like
        "Office of the Dean" or "Teacher Education Faculty" and placed in their
        actual home departments. This is the right call for accuracy, but it
        produces a few department buckets with very few people:
      </P>
      <Bullets>
      ...
      <P>
        ...
        percentile is mathematically degenerate, since the lone person sits at
        every extreme by default. Treat Dept percentile in small departments
        with caution.
      </P>
      <P>
