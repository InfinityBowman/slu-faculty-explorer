  ...
  return (
    <Section id="overview" title="Overview">
      <P>
        ...
        nine schools and 61 departments at Saint Louis University. The unit of
        analysis is the individual faculty member.
      </P>
      <P>
        ...
        dataset combines a per-faculty record (Google Scholar, OpenAlex, SLU bio
        data) with two percentile systems: one against SLU peers in the same
        department, and one against the global population of active researchers
        in the same OpenAlex field.
      </P>
      <Callout>
        Before drawing conclusions from any rank, read the{' '}
        <Anchor href="#percentile-systems">two percentile systems</Anchor>{' '}
        section. The two systems answer different questions and should not be
        mixed up.
      </Callout>
    </Section>
  )
